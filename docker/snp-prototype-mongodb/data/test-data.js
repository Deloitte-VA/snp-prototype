...
mydb.patients.insert( 
	[
		{ "_id": NumberLong(10000001), "first_name": "Diann", "middle_name": "Agnese", "last_name": "Ayers", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) },
		{ "_id": NumberLong(10000002), "first_name": "Annalee", "middle_name": "Marlee", "last_name": "Coleman", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) }, 
		{ "_id": NumberLong(10000003), "first_name": "Victor", "middle_name": "Menahem", "last_name": "Lemmi", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(2), "race": NumberInt(1) }, 
		{ "_id": NumberLong(10000004), "first_name": "Christi", "middle_name": "Battista", "last_name": "Tobin", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) }, 
		{ "_id": NumberLong(10000005), "first_name": "Kerrie", "middle_name": "Gottlob", "last_name": "Fiscella", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) }, 
		{ "_id": NumberLong(10000006), "first_name": "Kathy", "middle_name": "Jennifer", "last_name": "Simpson", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(2), "race": NumberInt(1) },
		{ "_id": NumberLong(10000007), "first_name": "Nina", "middle_name": "Audie", "last_name": "Breckenridge", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) }, 
		{ "_id": NumberLong(10000008), "first_name": "Dollie", "middle_name": "Jennie", "last_name": "Barnes", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) }, 
		{ "_id": NumberLong(10000009), "first_name": "Tayla", "middle_name": "Casey", "last_name": "Geiger", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) }, 
		{ "_id": NumberLong(10000010), "first_name": "Jeanne", "middle_name": "Ovidio", "last_name": "Morrison", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(2) }, 
		{ "_id": NumberLong(10000011), "first_name": "Romano", "middle_name": "Horatio", "last_name": "Wash", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(2), "race": NumberInt(1) }, 	
		{ "_id": NumberLong(10000012), "first_name": "Anthony", "middle_name": "Michael", "last_name": "Campo", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) },
		{ "_id": NumberLong(10000013), "first_name": "Zion", "middle_name": "Jaki", "last_name": "Ridley", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(2), "race": NumberInt(4) },
		{ "_id": NumberLong(10000014), "first_name": "Jonathon", "middle_name": "Greg", "last_name": "Colbert", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(2), "race": NumberInt(1) },
		{ "_id": NumberLong(10000015), "first_name": "Kimberly", "middle_name": "Vivyan", "last_name": "Vipond", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(4) },
		{ "_id": NumberLong(10000016), "first_name": "Fanny", "middle_name": "Sadb", "last_name": "Altimari", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(3) },
		{ "_id": NumberLong(10000017), "first_name": "Guy", "middle_name": "Bob", "last_name": "Johnson", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(2), "race": NumberInt(2) },
		{ "_id": NumberLong(10000018), "first_name": "Hannah", "middle_name": "Conall", "last_name": "Peterson", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) },
		{ "_id": NumberLong(10000019), "first_name": "Clarissa", "middle_name": "Dorothea", "last_name": "Fay", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(5) },
		{ "_id": NumberLong(10000020), "first_name": "Liberty", "middle_name": "Vinzent", "last_name": "Coel", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(2) },
		{ "_id": NumberLong(10000021), "first_name": "Roscoe", "middle_name": "Alvin", "last_name": "Franklin", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(2), "race": NumberInt(1) },	
		{ "_id": NumberLong(10000022), "first_name": "Faye", "middle_name": "Wilmer", "last_name": "Sexton", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(5) },
		{ "_id": NumberLong(10000023), "first_name": "Sergio", "middle_name": "Kalyn", "last_name": "Allard", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(2), "race": NumberInt(4) },
		{ "_id": NumberLong(10000024), "first_name": "Adelina", "middle_name": "Sheldon", "last_name": "Tirrell", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) },
		{ "_id": NumberLong(10000025), "first_name": "Lanny", "middle_name": "Michela", "last_name": "McNaughton", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) },
		{ "_id": NumberLong(10000026), "first_name": "Matteo", "middle_name": "Henrike", "last_name": "Brennan", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(2), "race": NumberInt(2) },
		{ "_id": NumberLong(10000027), "first_name": "Richard", "middle_name": "Demetrio", "last_name": "Jernigan", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(2), "race": NumberInt(3) },
		{ "_id": NumberLong(10000028), "first_name": "Melany", "middle_name": "Chanel", "last_name": "Durant", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) },
		{ "_id": NumberLong(10000029), "first_name": "Christine", "middle_name": "Karl", "last_name": "Haley", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(2) },
		{ "_id": NumberLong(10000030), "first_name": "Claudia", "middle_name": "Alannah", "last_name": "Connell", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(3) },
		{ "_id": NumberLong(10000031), "first_name": "Billie", "middle_name": "Brad", "last_name": "Pisani", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(2), "race": NumberInt(1) },
		{ "_id": NumberLong(10000032), "first_name": "Lorena", "middle_name": "Bridger", "last_name": "Jack", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) },
		{ "_id": NumberLong(10000033), "first_name": "Elisabeth", "middle_name": "Sesto", "last_name": "Trudu", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) },
		{ "_id": NumberLong(10000034), "first_name": "Lacy", "middle_name": "Lori", "last_name": "McNeil", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(2) },
		{ "_id": NumberLong(10000035), "first_name": "Rodolphe", "middle_name": "Giustino", "last_name": "Underwood", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(2), "race": NumberInt(2) },
		{ "_id": NumberLong(10000036), "first_name": "Karen", "middle_name": "Aniya", "last_name": "Quinn", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(2) },
		{ "_id": NumberLong(10000037), "first_name": "Jacquelyn", "middle_name": "Quirin", "last_name": "Milford", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(2) },
		{ "_id": NumberLong(10000038), "first_name": "Konnor", "middle_name": "Markus", "last_name": "Riese", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(2), "race": NumberInt(1) },
		{ "_id": NumberLong(10000039), "first_name": "Sharyn", "middle_name": "Martha", "last_name": "Appleby", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) },
		{ "_id": NumberLong(10000040), "first_name": "Detta", "middle_name": "Ronda", "last_name": "Marchetti", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) },
		{ "_id": NumberLong(10000041), "first_name": "Arlene", "middle_name": "Dell", "last_name": "Thorley", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(3) },
		{ "_id": NumberLong(10000042), "first_name": "Sheila", "middle_name": "Moritz", "last_name": "Bray", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(3) },
		{ "_id": NumberLong(10000043), "first_name": "Crispin", "middle_name": "Bret", "last_name": "Summers", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(2), "race": NumberInt(2) },
		{ "_id": NumberLong(10000044), "first_name": "Etta", "middle_name": "Ziska", "last_name": "Thacker", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) },
		{ "_id": NumberLong(10000045), "first_name": "Antonina", "middle_name": "Donatien", "last_name": "Walter", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) },
		{ "_id": NumberLong(10000046), "first_name": "Mathew", "middle_name": "Franklin", "last_name": "Fairchild", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(2), "race": NumberInt(1) },
		{ "_id": NumberLong(10000047), "first_name": "Chevonne", "middle_name": "Bertrand", "last_name": "Northrop", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(1), "race": NumberInt(1) },
		{ "_id": NumberLong(10000048), "first_name": "Leopold", "middle_name": "Nia", "last_name": "Duff", "dob": new Date('04/15/1955').getTime(), "gender": NumberInt(2), "race": NumberInt(1) }
	]
);
