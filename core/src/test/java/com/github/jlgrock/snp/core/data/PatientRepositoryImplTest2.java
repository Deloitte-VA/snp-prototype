...
public class PatientRepositoryImplTest2 {
	
	@Mock
	PatientRepositoryImpl mockedPRI;
	...
	public void testFindAllByDateOfBirth(){
		...
		Date dateOfBirth = new Date(2001, 1, 1);
	...
	public void testFindAllByLastName(){
	    ...
	    assertEquals(mockedPRI.findAllByLastName(lastName), mockedPRI.executeQueryAndTransformResults(query2));
	    assertEquals(mockedPRI.findAllByLastName(lastName), mockedPRI.dBCollection().find(query2));
