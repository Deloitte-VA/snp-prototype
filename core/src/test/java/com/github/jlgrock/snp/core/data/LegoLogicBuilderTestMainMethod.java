...
public class LegoLogicBuilderTestMainMethod {
	...
	private static Expression populateTestData(Expression expression) {
		...
		sourceConcept.setSctid(439272007L);
		...
		relationTypeConcept.setSctid(704647008L);
		...
		destinationConcept.setSctid(46973005L);
		...
		expression.getRelation().addAll(relationsList);
