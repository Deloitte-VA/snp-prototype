...
@HK2(populate = false)
public class FhirControllerTest extends GenericControllerTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(FhirControllerTest.class);
    ...
    public void testPartWithFile() {
        ...
        final WebTarget target = target().path("fhir/upload");
    ...
    public void testStreamingXml() {
    	...
    	final WebTarget target = target().path("fhir");
