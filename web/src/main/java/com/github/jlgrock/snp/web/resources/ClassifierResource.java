...
public class ClassifierResource {
     ...
     * @param identifier (optional) the unique identifier, if applicable
    ...
    public Response postFile(final FormDataMultiPart form, @FormDataParam("id") final String identifier) {
        ...
        for (FormDataBodyPart filePart : fileParts) {
            ...
            if (LOGGER.isDebugEnabled()) {
                for (Entry<MediaType, List<MessageBodyReader>> readerMediaType : readers.entrySet()) {
     ...
     */
    private void processFile(final String input, final MediaType mediaType, final String identifier) {
        ...
        processingServiceFactory.getService(mediaType).processInput(input, identifier);
    }
}
