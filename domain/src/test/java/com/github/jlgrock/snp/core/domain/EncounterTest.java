...
public class EncounterTest {
	...
	public void testSettersAndGetters() {
        ...
        assertEquals(en1.getPatientClass(), clazz1);
	...
	public void testToString() {
		...
		assertEquals(en1.toString(), "Encounter{id=201521, fhirId=f203, subject=Patient/f203, patientClass=OUTPATIENT, status=FINISHED, participant=Practitioner/f201, observations=null}");
	}
